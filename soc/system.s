...
x2 = mem[x1 + 0]
x4 = 1 + x0
if x2 == x4, // interruption by uart, clear uart memory area
    x10 = 206800
    while x10 != x1,
        mem[x10 + 0] = x0
        x10 = x10 + 1
    endwhile
    x3 = mem[x1 + 2] // clear button request
endif
x3 = mem[x1 + 2] // read button request
x4 == x3 goto Main // start main function
